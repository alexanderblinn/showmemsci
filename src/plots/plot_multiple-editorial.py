        ...
        steps.append(
            dict(
                ...
                args=[
                    {
                        "line.width": [
                            HIGHLIGHT_WIDTH if index in highlight_indices else BASE_LINE_WIDTH
                            for index in range(total_traces)
                        ],
                        "line.color": [
                            HIGHLIGHT_COLOR if index in highlight_indices else BASE_LINE_COLOR
                            for index in range(total_traces)
                        ],
                        "opacity": [
                            HIGHLIGHT_OPACITY if index in highlight_indices else BASE_LINE_OPACITY
                            for index in range(total_traces)
                        ],
                    },
...
def main() -> None:
    ...
    theme.render_html(
        fig,
        SAVE_HTML_TO,
        eyebrow="Multiple / Editorial Edition",
        title="Yearly Profiles",
        deck=(
        ...
        kicker="Every year starts at zero<br />hover or slide to isolate one path",
        meta_items=[
            summary["span"],
            summary["years"],
            summary["latest"],
        ...
        footer_left="Profiles are normalized within each year, then stacked in one common calendar frame.",
